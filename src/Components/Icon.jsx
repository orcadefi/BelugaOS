...
class Icon extends React.Component {
    ...
    render() {
        return (
            <div data-tooltip="Coming soon" id={"id-" + this.props.id} className={"icon-div" + this.state.divName + " " + (this.props.comingsoon ? "tooltip" : "")} onClick={() => (typeof this.state.action === "function" ? this.state.action() : createWindow(this.state.action, addWindow(windowIDs[this.state.action])))}>
